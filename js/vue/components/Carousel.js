...
const Carousel = {
		...
		return {
			slides: [
				...
				},
				{
					...
					thumbnail: "./images/index_slider/natural-parks.jpg",
				...
				},
				{
					...
					thumbnail: "./images/index_slider/ruins.jpg",
	...
	methods: {
		...
		initTyping() {
			this.$nextTick(() => {
				const titleEl = this.sliderDom.querySelector(
					".carousel__list > .carousel__item:nth-child(1) .carousel__item__title",
				);
		...
		showSlider(type) {
			...
			const thumbnailItems = this.thumbnailDom.querySelectorAll(
